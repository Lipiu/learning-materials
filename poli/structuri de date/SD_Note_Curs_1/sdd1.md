...
### Divide-et-impera
**Folosire:** design de algoritmi eficienti
**Definitie:** Presupune impartirea problemei initiale in sub-probleme, de obicei disjuncte, care pot fi rezolvate independent, iar apoi solutiile lor sunt combinate pentru a obtine solutia problemei initiale
**Exemple:** MergeSort, QuickSort

### Greedy
**Folosire:** rezolvarea problemelor de optimizare
**Definitie:** algoritmul greedy alege la fiecare pas decizia cea mai favorabila, fara a evalua global eficienta solutiei. 
**Exemple:** Djikstra, Huffman

### Programare dinamica
**Folosire:** rezolvarea problemelor de optimizare (similar cu greedy)
**Definitie:**  presupune rezolvarea unei probleme prin descompunerea ei in subprobleme similare, rezolvarea acestora si combinarea subsolutiilor. Rezolvarea se face pornind de la cele mai mici subprobleme, si folosindu-ne de rezultatul acestora, iterativ calculam subproblemele de dimensiune mai mare folosind solutii mai mici, deja calculate.
**Tehnici:** Memorizare - pentru a nu recalcula solutiile subproblemelor care ar trebui rezolvate de mai multe ori, pe ramuri diferite, se retine solutia subproblemelor folosing o tabela cu rezultatul fiecarei subprobleme.
**Deosebire fata de divide-et-impera:** subproblemele nu sunt disjuncte, ci de multe ori acestea chiar sunt identice sau se suprapun
**Exemple:** genetica (sequence alignment), cautare optima, teoria grafurilor (Floyd-Warshall), metode de antrenare a retelelor neuronale (Adaptive Critic training strategy), algoritmul Cocke-Younger-Kasami

### Backtracking
**Folosire:** cand nu se poate utiliza un algoritm mai eficient
**Definitie:** tehnica de tip, "incearca si verifica eroarea" sau "cautare oarba", in general ineficienta, de aplicat cand alte scheme de algoritmi mai eficiente nu pot fi aplicate.
**Exemple:** permutari, NP-complete
